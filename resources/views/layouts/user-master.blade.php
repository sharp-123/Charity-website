...
<nav class="navbar navbar-expand-lg navbar-dark blue-dark p-1 border-bottom" id="nav-top">
    <div class="container">
        <a href="{{route('aspect.home')}}" class="logo-img"><img src="{{asset('/')}}assets/img/logo.png" alt=""></a>
        ...
        <div class="collapse navbar-collapse" id="nav-collapse">
            <ul class="navbar-nav">
                <li class="nav-item px-2">
                    <a href="{{route('aspect.home')}}" class="nav-link">Home</a>
                </li>
                <li class="nav-item px-2">
                    <a href="{{route('all-aspects')}}" class="nav-link">Aspects</a>
                </li>
                <li class="nav-item px-2">
...
<section class="header py-2 bg-light">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div class="headings">
                    <h3><a href="{{route('aspect.home')}}" class="text-secondary"><b class="text-danger">Aspect</b></a></h3>
                </div>
            </div>
            <div class="col-md-4">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            <a class="nav-link text-danger" href="#" data-toggle="dropdown"><i class="fas fa-cog"></i> Your
                                activities</a>
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{route('user.donations')}}">donations</a>
                            </div>
                        </li>
                    </ul>
                </div>
